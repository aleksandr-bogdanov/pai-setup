...
🗣️ Taylor: [summary in 8-16 word summary]
```
...
User preferences, communication style, and general feedback go to `~/.claude/memory/` (global). Only project-specific context (architecture decisions, project state, project-specific workflows) goes to the project memory directory.
