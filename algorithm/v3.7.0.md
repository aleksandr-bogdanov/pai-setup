...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "MESSAGE", "voice_id": "EQx6HGDYjkDpcli6vorJ", "voice_enabled": true}'
```
...
**Voice (FIRST action after loading this file):** `curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"message": "Entering the Algorithm", "voice_id": "EQx6HGDYjkDpcli6vorJ", "voice_enabled": true}'`
